...
- 数学类
  - 高等数学（难度从低到高）
    - 微积分基础（一学期）
    - 微积分I 上/下（化工类，上册5学分，下册4学分，不考级数）
    - 微积分II 上/下（非化工类，上下册均为5学分，考级数）
    - 工科数学分析 上/下（计算机、软件、百步梯、信工创新班，上册5学分，下册7学分）
    - 数学分析 上/下（仅数学学院修读）
  - 线性代数与解析几何
  - 概率论与数理统计
  - 复变函数与积分变换
- 英语类（A班修读学术英语，B、C班修读大学英语）
...
- [ ] 课程内容概要：线性方程组、矩阵运算、向量空间、特征值与特征向量等核心章节
- [ ] 推荐教材与参考书：同济版《线性代数》及配套习题集
- [ ] 学习资源：网课推荐（如 MIT 18.06 线性代数）、华工往年真题与复习笔记
...
- [ ] 课程内容概要：概率公理、随机变量、大数定律与中心极限定理、数理统计基础
- [ ] 推荐教材与参考书：浙大版《概率论与数理统计》及习题全解
- [ ] 学习资源：网课推荐、华工往年真题与复习笔记
...
- [ ] 课程内容概要：复数与复变函数、解析函数、复积分、级数与留数定理
- [ ] 推荐教材与参考书：西交版《复变函数》及配套习题集
- [ ] 学习资源：网课推荐、华工往年真题与复习笔记
