---
lang: en-US
title: Common Basic Courses
description: Introduces the common basic courses offered at SCUT and links to related study materials
llm_translated: true
---
...
- **Mathematics**
  - Advanced Mathematics (difficulty from low to high)
    ...
    - Calculus I (Part 1/Part 2) (Chemical Engineering track, Part 1 = 5 credits, Part 2 = 4 credits, no series)
    - Calculus II (Part 1/Part 2) (Non-chemical Engineering track, both parts = 5 credits, includes series)
    - Engineering Mathematical Analysis (Part 1/Part 2) (Computer Science, Software, Baibu Step, Information Engineering Innovation Class, Part 1 = 5 credits, Part 2 = 7 credits)
    - Mathematical Analysis (Part 1/Part 2) (School of Mathematics only)
  - Linear Algebra and Analytic Geometry
  - Probability Theory and Mathematical Statistics
  - Complex Functions and Integral Transforms
- **English** (Track A takes Academic English, Tracks B and C take College English)
...
- Advanced Mathematics Quick Reference (@Mike_Unknown): [Advanced Mathematics Quick Reference PDF](https://fastgit.cc/https://raw.githubusercontent.com/Kozmosa/survive-in-scut/main/assets/%E9%AB%98%E7%AD%89%E6%95%B0%E5%AD%A6%E9%80%9F%E6%9F%A5%E8%A1%A8.pdf)
...
- _Oplisty_'s **SCUT University Physics Review Notes** (also applicable to the International Campus):
